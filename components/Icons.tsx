...
export const BrainCircuitIcon = (): React.ReactNode => (
    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-cyan-400">
        <path d="M12 5a3 3 0 1 0-5.993.142"/><path d="M18 12.142a3 3 0 1 0-2.142 5.712"/><path d="M12 19a3 3 0 1 0 5.993-.142"/><path d="M6 12.142a3 3 0 1 0 2.142-5.712"/><path d="M14.142 6.858 12 5"/><path d="M12 19l-2.142-1.142"/><path d="M9.858 17.142 12 19"/><path d="M6 12.142 9.858 9.858"/><path d="M14.142 17.142 18 12.142"/><path d="M9.858 14.142 6 12.142"/><path d="M12 5l2.142 1.142"/><path d="M12 5a3 3 0 0 0 0 6"/><path d="M12 13a3 3 0 0 0 0 6"/><path d="M12 13h.01"/><path d="M12 7h.01"/></svg>
);
...
export const PhotoIcon = (): React.ReactNode => (
  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
  </svg>
);

export const XCircleIcon = (): React.ReactNode => (
...
export const ExclamationTriangleIcon = (): React.ReactNode => (
